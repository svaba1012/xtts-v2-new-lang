...
_ordinal_re = {
    ...
    "sr": re.compile(r"([0-9]+)\.(?=\s|$)"),  # In Serbian, a dot is often used after the number to indicate ordinals.
}
...
class VoiceBpeTokenizer:
    ...
    def preprocess_text(self, txt, lang):
        if lang in {"ar", "cs", "de", "en", "es", "fr", "hi", "hu", "it", "nl", "pl", "pt", "ru", "tr", "zh", "ko", "sr"}:
